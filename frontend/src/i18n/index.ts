...
const resources = {
  uz: {
    translation: {
      ...
      "liveChat": "Jonli chat",
      "liveChatDescription": "Telegram orqali qo'llab-quvvatlash jamoamizdan darhol yordam oling",
      "startChat": "Telegram chatni boshlash",
      "helpCenter": "Yordam markazi",
      "helpCenterDescription": "Telegram orqali keng qamrovli FAQ va qo'llanmalarni ko'rib chiqing",
      "visitHelpCenter": "Telegram yordam markaziga tashrif buyuring",
      "communityForum": "Jamoa forumi",
      "communityForumDescription": "Telegram orqali boshqa o'quvchilar va o'qituvchilar bilan bog'laning",
      "joinCommunity": "Telegram guruhiga qo'shiling",
  ...
  en: {
    translation: {
      ...
      "liveChat": "Live Chat",
      "liveChatDescription": "Get instant help from our support team via Telegram",
      "startChat": "Start Telegram Chat",
      "helpCenter": "Help Center",
      "helpCenterDescription": "Browse our comprehensive FAQ and guides via Telegram",
      "visitHelpCenter": "Visit Telegram Help Center",
      "communityForum": "Community Forum",
      "communityForumDescription": "Connect with other learners and instructors via Telegram",
      "joinCommunity": "Join Telegram Group",
  ...
  ru: {
    translation: {
      ...
      "liveChat": "Живой чат",
      "liveChatDescription": "Получите мгновенную помощь от нашей команды поддержки через Telegram",
      "startChat": "Начать чат в Telegram",
      "helpCenter": "Центр помощи",
      "helpCenterDescription": "Просмотрите наши всеобъемлющие FAQ и руководства через Telegram",
      "visitHelpCenter": "Посетить центр помощи в Telegram",
      "communityForum": "Форум сообщества",
      "communityForumDescription": "Свяжитесь с другими учащимися и преподавателями через Telegram",
      "joinCommunity": "Присоединиться к группе Telegram",
