  ...
  const loadBlogPost = async () => {
    try {
      ...
      if (id) {
        ...
        // For now, use demo related posts since API doesn't have getRelatedPosts
        setRelatedPosts([])
      } else {
        // Use demo data
        const demoPost: BlogPost = {
          ...
          slug: 'future-of-online-learning-2025',
          content: `
        ...
        const demoRelated: BlogPost[] = [
          {
            ...
            slug: 'essential-developer-skills-2025',
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mb-4">
                {post.author.firstName} is an education technology expert with over 10 years of experience in online learning platforms.
              </p>
